...
import { ToggleGroup, ToggleGroupItem } from '@morgan-wrestling/ui/components/ui/toggle-group';
...
export const TextAlignToggle = ({
	size,
}: VariantProps<typeof textAlignVariants>) => {
	...
	return (
		<ToggleGroup
			...
			spacing={1}
		>
			<ToggleGroupItem value='left' aria-label='seft-left-align'>
				<TextAlignStartIcon />
			</ToggleGroupItem>
			<ToggleGroupItem value='center' aria-label='set-center-align'>
				<TextAlignCenterIcon />
			</ToggleGroupItem>
			<ToggleGroupItem value='right' aria-label='set-right-align'>
				<TextAlignEndIcon />
			</ToggleGroupItem>
		</ToggleGroup>
	);
