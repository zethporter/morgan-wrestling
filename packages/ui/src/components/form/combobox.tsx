...
import { Combobox, ComboboxContent, ComboboxEmpty, ComboboxInput, ComboboxList, ComboboxItem } from "../ui/combobox";
...
type FormInputProps = {
  ...
  placeholder?: string;
} & Omit<ComponentProps<typeof Combobox>, 'id' | 'name' | 'onBlur' | 'onChange' | 'className'>;;
...
export const FormInput = (props: FormInputProps) => {
  ...
  return (
    <Field className={cn(props.className)} data-invalid={isInvalid} data-disabled={props.disabled}>
      ...
      <Combobox aria-invalid={isInvalid}
        items={props.items}
        id={props.field.name}
        value={props.field.state.value}
        onValueChange={props.field.handleChange}
      >
        <ComboboxInput className={cn(props.inputClassName)} aria-invalid={isInvalid} placeholder={props.placeholder} onBlur={props.field.handleBlur} />
        <ComboboxContent>
